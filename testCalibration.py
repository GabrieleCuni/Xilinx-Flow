...
def my_test_calibration(x_test, y_test, image_names):
    ...
    with tf.compat.v1.Session() as sess:
        ...
        #     print(f"Pred: {p},GT: {y_test[i]}, {image_names[i]}")
...
random.seed(42)
x_test, y_test, image_names = makeTestSet(imageSize=int(args.model.split("_")[3]))
# print(x_test[0].shape, y_test[0])
my_test_calibration(x_test, y_test, image_names)
